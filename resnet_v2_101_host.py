...
def deal_image_func(image, input_size):
...
def test_extern_vitis_ai_resnet_v2_101():
    ...
    image_data = deal_image_func('cat.jpg',224)
    shape_dict = {'Placeholder': image_data.shape}
    ...
    classes = read_class_names('labels.txt')
    num_classes = len(classes)
...
if __name__ == "__main__":
    if sys.platform == "win32":
        ...
        sys.exit(0)
    test_extern_vitis_ai_resnet_v2_101()
